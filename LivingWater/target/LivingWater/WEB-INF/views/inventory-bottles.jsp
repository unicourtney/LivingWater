	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row">
				...
				<button class="btn btn-success btn-lg" data-toggle="modal" data-target="#addBottleModal">
					Add Bottle
				</button>
					<button class="btn btn-warning btn-lg" data-toggle="modal" data-target="#updateBottleModal">
						Update Bottle
					</button>
				</div>
				<div class="modal fade" id="addBottleModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="${pageContext.request.contextPath}/addBottle"
									  method="POST" >
				...
				<div class="modal fade" id="updateBottleModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
								<h4 class="modal-title" id="myModalLabel2">Modal title Here</h4>
							</div>
							<div class="modal-body">
								<form action="${pageContext.request.contextPath}/updateBottle"
									  method="POST" >
									<div class="form-group">
										<label>Bottle ID</label>
