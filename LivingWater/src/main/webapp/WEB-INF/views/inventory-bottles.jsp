    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                ...
                <button class="btn btn-success btn-default" data-toggle="modal" data-target="#addBottleModal">
                    Add Bottle
                </button>

                <button class="btn btn-warning btn-default" data-toggle="modal" data-target="#updateBottleModal">
                    Update Bottle
                </button>
                <hr>
            </div>

            <div class="modal fade" id="addBottleModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal fade" id="updateBottleModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                 aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title" id="myModalLabel2">Update Bottle</h4>
                        </div>
                        <div class="modal-body">
